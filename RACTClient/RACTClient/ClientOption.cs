...
namespace RACTClient
{
    ...
    public class ClientOption
    {
        ...
        /// <summary>
        /// Bastion 설정 정보입니다 (테스트용 샘플 데이터 포함).
        /// </summary>
        private BastionConfig m_BastionSetting = new BastionConfig
        {
            Hosts = new List<BastionHostInfo>
            {
                new BastionHostInfo { Host = "118.217.79.48", Port = 40002 },
                new BastionHostInfo { Host = "127.0.0.1", Port = 22 } // 백업 서버
            },
            Username = "ssh-tunnel",
            Password = "aug@201908"
        };
        public BastionConfig BastionSetting
        {
            get { return m_BastionSetting; }
            set { m_BastionSetting = value; }
        }

        /// <summary>
        /// Bastion 기능을 사용할지 여부입니다.
        /// </summary>
        private bool m_UseBastion = false;
        public bool UseBastion
        {
            get { return m_UseBastion; }
            set { m_UseBastion = value; }
        }
