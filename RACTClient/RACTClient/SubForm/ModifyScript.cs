...
namespace RACTClient
{
    public partial class ModifyScript : BaseForm
    {
        ...
        private void btnAddGroup_Click(object sender, EventArgs e)
        {
            ...
            tGroup.OnDulplicate += new ReturnHandlerArgument1<bool>(ModifyScript_OnDulplicatet);
            tGroup.InitializeControl();
            tGroup.ShowDialog();
        }

        private bool ModifyScript_OnDulplicatet(object aValue1)
        {
            MessageBox.Show($"그룹중복 체크:{aValue1}");
            return false;
        }
