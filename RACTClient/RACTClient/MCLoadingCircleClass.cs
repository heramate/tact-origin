...
{
    public partial class MCLoadingCircleClass : Control
    {
        ...
        private const int DefaultInnerCircleRadius = 13;
        ...
        private const int MacOSXInnerCircleRadius = 9;
        ...
        private const int FireFoxInnerCircleRadius = 15;
        private const int FireFoxOuterCircleRadius = 16;
       ...
       [ System.ComponentModel.Category("LoadingCircle")]
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            e.Graphics.DrawString(this.Text, this.Font, Brushes.Black, new Point((this.Width / 2) - (int)(tSize.Width / 2), this.Height / 2 - (int)(tSize.Height / 2)));
