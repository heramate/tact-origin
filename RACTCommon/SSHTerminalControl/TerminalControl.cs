...
{
    /// <summary>
    /// 2013-01-28 - SSH 데이타 값 받는 딜리게이트
    /// </summary>
    /// <param name="sender"></param>
    /// <param name="e"></param>
    public delegate void SSHReceivedDataEventHandler(object sender, SSHReceiveEventArgs e);

    public delegate void SSHDisConnectEventHandler(object sender);

    public class SSHReceiveEventArgs : EventArgs
    {

        public SSHReceiveEventArgs(string aReceivedData)
        {
            m_ReceivedData = aReceivedData;
        }
	...
	public class TerminalEmulator : Control
	{
        ...
        /// <summary>
        /// 2013-01-28 - SSH 결과값 받는 이벤트 핸들러
        /// </summary>
        public SSHReceivedDataEventHandler m_SSHReceivedDataEvent = null;

        public SSHDisConnectEventHandler m_SSHDisConnectEvent = null;
        ...
        public void Write(byte[] data, int offset, int length)
        {
            ...
            m_SSHReceivedDataEvent(this, new SSHReceiveEventArgs(sReceived));
		...
		public void Connect ()
		{
			switch (this.ConnectionType)
			{
				...
				{
					this.ConnectSSH2(this.Hostname, this.Port, this.Username, this.Password);
					break;
				}
				default:
				{
		...
		{ 
            ...
            //this.ScrollbackBufferSize = 10000;
        ...
        public void ConnectSSH2(string hostname, int port, string username, string password)
        {
            // connect ssh
            this.Focus();
            Routrek.SSHC.SSHConnection _conn;
	...
	class Reader : Routrek.SSHC.ISSHConnectionEventReceiver, Routrek.SSHC.ISSHChannelEventReceiver 
	{
		...
		public void OnDebugMessage(bool always_display, byte[] data) 
		{
            ...
            System.Diagnostics.Debug.WriteLine("DEBUG: " + Encoding.ASCII.GetString(data));
		}
		public void OnIgnoreMessage(byte[] data) 
		{
            System.Diagnostics.Debug.WriteLine("Ignore: " + Encoding.ASCII.GetString(data));
		}
		public void OnAuthenticationPrompt(string[] msg) 
		{
            System.Diagnostics.Debug.WriteLine("Auth Prompt " + msg[0]);
		}
		...
		{
            System.Diagnostics.Debug.WriteLine("Channel closed");
			_conn.Disconnect("");
            Terminal.m_SSHDisConnectEvent(this);
            //_conn.AsyncReceive(this);
        }
		public void OnChannelEOF() 
		{
			_pf.Close();
            System.Diagnostics.Debug.WriteLine("Channel EOF");
		}
		public void OnExtendedData(int type, byte[] data) 
		{
            System.Diagnostics.Debug.WriteLine("EXTENDED DATA");
		}
		...
		{
            System.Diagnostics.Debug.WriteLine("Unknown Message " + type);
		}
		...
		{
            System.Diagnostics.Debug.WriteLine("Channel ERROR: " + msg);
		}
