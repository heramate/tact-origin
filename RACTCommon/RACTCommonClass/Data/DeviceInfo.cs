...
namespace RACTCommonClass
{
    ...
    public class DeviceInfo : ICloneableEx<DeviceInfo>
    {
        ...
        private void CopyTo(DeviceInfo aSource, DeviceInfo aDest, bool aIsCompactClone)
        {
            ...
            // 20260213 ShinMyungsu User별 장비접속권한(MangTypeCd 망구분) 
        ...
        /// <summary>
        /// 20260213 ShinMyungsu User별 장비접속권한  MangTypeCd(망구분) 추가
        /// </summary>
        private string m_MangTypeCd = string.Empty;
        public string MangTypeCd
        {
            get { return m_MangTypeCd; }
            set { m_MangTypeCd = value; }
        }
